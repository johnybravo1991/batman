    ...
    public partial class MainForm : Form
    {
       ...
       // public bool write;
        ...
        public void DrawLocation(PXCMEmotion.EmotionData[] data)
        {
            lock (this)
            {
                ...
                if ((epidx != -1) && (maxscoreI > 0.4))
                {
                    try
                    {
                        if (data[0].emotion.Equals(PXCMEmotion.Emotion.EMOTION_SENTIMENT_POSITIVE))
                        {
                            LedOn();
                        }
                        else
                        ...
                        this.Text = data[0].emotion.ToString();
                ...
                if (emotionPresent)
                {
                    ...
                    if ((spidx != -1))
                    {
                        ...
                        {
                            this.Text = data[0].emotion.ToString();
                          // MessageBox.Show(data[0].emotion.ToString());
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            _serialPort.PortName = "COM15"; //Serial port Edison is connected to
